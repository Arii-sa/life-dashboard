...
```mermaid
graph TD
    A["🖥 クライアント<br/>Next.js / TypeScript / Tailwind CSS"]
    A -->|HTTP/REST API<br/>Bearer Token Sanctum| B

    B["⚙️ バックエンド<br/>Laravel 11 / PHP 8.4"]
    B --> C

    C[("🗄 データベース<br/>MySQL 8.0")]

    D["🐳 開発環境<br/>Docker / docker-compose"]
    E["☁️ ホスティング<br/>Vercel（フロントエンド）"]
